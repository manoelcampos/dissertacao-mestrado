...
local request = [[POST http://www.webservicex.net/CurrencyConvertor.asmx HTTP/1.0
...
local function sendRequest()
  tcp.execute(
        function ()
            local host, port = "www.webservicex.net", 80
            ...
            tcp.disconnect()
      	    ...
      	    print("Valor em KB: ", kb) --75.59 KB de uso de RAM
      	    --pico de CPU: 0.3%
        end
  )  x  
end
